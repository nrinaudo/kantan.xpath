...
class LongEnumCodecTests extends DisciplineSuite {
  ...
  checkAll("NodeDecoder[EnumeratedLong]", SerializableTests[NodeDecoder[EnumeratedLong]].serializable)
  checkAll("NodeDecoder[EnumeratedLong]", NodeDecoderTests[EnumeratedLong].decoder[String, Float])
